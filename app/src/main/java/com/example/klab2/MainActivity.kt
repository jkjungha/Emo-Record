...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val a1 = db.getReference("users").child(LoginActivity.username)
            .child("get_items").child("exciting_bgm/chose").get()
            .addOnSuccessListener{
                val value1 = it.value.toString().toInt()
                if(value1==1){
                    bgmIntent =
        ...
        val a2 = db.getReference("users").child(LoginActivity.username)
            .child("get_items").child("sea_bgm/chose").get()
            .addOnSuccessListener{
                val value1 = it.value.toString().toInt()
                if(value1==1){
                    bgmIntent =
        ...
        val a3 = db.getReference("users").child(LoginActivity.username)
            .child("get_items").child("soft_bgm/chose").get()
            .addOnSuccessListener{
                val value1 = it.value.toString().toInt()
                if(value1==1){
                    bgmIntent =
        ...
        val a4 = db.getReference("users").child(LoginActivity.username)
            .child("get_items").child("forest_bgm/chose").get()
            .addOnSuccessListener{
                val value1 = it.value.toString().toInt()
                if(value1==1){
                    bgmIntent =
